...
def test_hover_key_links_hover_across_composed_plots(page, tmp_output_dir, load_html):
    left = pd.DataFrame(
        {
            "x": [1, 2],
            "y": [2, 4],
    ...
    html_path = _render_plot(tmp_output_dir, "linked-hover-composition", p1 | p2)
    load_html(page, html_path)
